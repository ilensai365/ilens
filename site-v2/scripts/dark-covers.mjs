...
// one graphite background, ivory type and acid-lime accents, so all covers read as one series.
// Usage: node scripts/dark-covers.mjs  → public/images/dark/*.svg (sources: public/images/*.svg)
import fs from "fs";
